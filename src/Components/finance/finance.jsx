...
>>>>>>> e57aace4253b5be8fbd4b4df7c1698267289afae
          ...
          đặc biệt 100% portfolio ứng tuyển học bổng sẽ được các mentor 
        ...
        <div className="font-body text-10 font-medium mt-5 ml-5 mr-10 flex flex-col">
          <p className="">
            Học phí <span className="font-head text-20 font-semibold mt-5 ml-5 text-center">8.500.000 VND</span>
          </p>
        ...
        <p className="mt-8 ml-2 text-[25px] font-hand">
            {" "}
            Xem chi tiết
          </p>
        </div>
